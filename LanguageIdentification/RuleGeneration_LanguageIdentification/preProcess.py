...
class PreProcessing:
    def __init__(self, language):
        ...
        results_folder = f"{base_path}/LanguageIdentification/RuleGeneration_LanguageIdentification/Results"
        self.input_file = f"{base_path}/Results/dataset/dataset_{language}.csv"
        self.output_file = f"{results_folder}/preprocessed/preprocessed_{language}.csv"
        self.dictionary_file = f"{base_path}/LanguageIdentification/RuleGeneration_LanguageIdentification/Dictionary/{language}_dictionary.csv"
...
if __name__ == "__main__":
    ...
    for language in languages:
        processor = PreProcessing(language)
